"""Tests for the ERCOT climatology baseline (L0 §7)."""
...
def test_fit_base_rate_per_hour_month() -> None:
    ...
    assert b.rates[(18, 1)] == 0.5  # 2 spikes / 4 at 18:00 in January
...
def test_predict_uses_table_then_global_fallback() -> None:
    ...
    assert p[0] == 0.5  # (18, January) known
    assert p[1] == b.global_rate  # (12, June) unknown -> global fallback
